...
public class NewKartScript : MonoBehaviour
{
    [System.Serializable]
    ...
    public NewKartScript.Stats baseStats = new NewKartScript.Stats
    {
        TopSpeed = 10f,
        Acceleration = 5f,
    ...
    NewKartScript.Stats m_FinalStats;
    ...
    //        WantsToDrift = Input.Braking && Vector3.Dot(Rigidbody.velocity, transform.forward) > 0.0f;
    //    }
    //}
    ...
    public float LocalSpeed()
    {
        ...
        else
        {
            ...
            return Input.Accelerating ? 1.0f : 0.0f;
        }
    }
